...
- Added / and /health endpoints to MCP HTTP server and updated Render healthCheckPath to /health.

- Added POST / as an MCP entry point (mirror of /mcp) to maximize connector compatibility.
